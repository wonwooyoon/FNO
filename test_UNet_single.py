...
def test_unet_single():
    print("="*60)
    print("Testing UNet_pure.py - SINGLE mode")
    print("="*60)
    ...
    try:
        ...
        UNet_pure.CONFIG.update({
            ...
            'TRAINING_CONFIG': {
                ...
                'eval_model_path': './test_output_unet/final/best_model_state_dict.pt'
            }
        })
        ...
        # Run the test
        print("\nRunning UNet_pure.py single mode test...")
        UNet_pure.main()
        
        print("\n✅ UNet_pure.py single mode test PASSED!")
        
    except Exception as e:
        print(f"\n❌ UNet_pure.py single mode test FAILED: {e}")
        raise
