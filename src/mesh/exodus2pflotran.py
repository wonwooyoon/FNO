...
if __name__ == "__main__":
    ...
    exodus_path = './src/mesh/mesh_full_hr_modified.e'
    hdf_path = './src/mesh/output_hr_modified/mesh.h5'
    sideset_dataset_path = ['/Regions/Sideset1', '/Regions/Sideset2']
    ascii_file_path = ['./src/mesh/output_hr_modified/sideset1.ss', './src/mesh/output_hr_modified/sideset2.ss']
    ...
    for key in material_dic.keys():
        ...
        writer.save_to_file(f'./src/mesh/output_hr_modified/{key}.txt')
