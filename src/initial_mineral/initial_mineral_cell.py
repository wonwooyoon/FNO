...
def process_all_data(mesh_file_path, mineral_output_dir, total_files=100, batch_size=50):
    """전체 데이터 처리 메인 함수"""
    print("=" * 60)
...
def main():
    """메인 함수 - 전체 워크플로우"""
    # 설정
    mesh_file_path = '/home/geofluids/research/FNO/src/mesh/output_128/mesh.h5'
